...
export class ReactTableExcel extends React.Component {
    ...
    handleDownload() {
        ...
        element.href =
            uri +
            ReactTableExcel.base64(
                ReactTableExcel.format(template, context),
            );
...
ReactTableExcel.prototypes = propTypes;
ReactTableExcel.defaultProps = defaultProps;

export default ReactTableExcel;